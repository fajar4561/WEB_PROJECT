                ...
                <div class="card-footer bg-light pt-0">
                  ...
                  <div class="d-flex mt-3">
                    ...
                    <div class="flex-1 ms-2 fs--1">
                      <p class="mb-1 bg-200 rounded-3 p-2"><a class="fw-semi-bold" href="#!"><?=$pecah['nama']?></a> Produk <a href="#!"><?=$data_3['nama_produk']?></a> <br> <?=$data_3['komentar']?> <br> , <?=$tampil_rating2?>.</p>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-1 ms-2">
                      ...
                      <button class="btn btn-light btn-sm py-0 mt-1 border" type="button"><span class="fas fa-user-plus" data-fa-transform="shrink-5 left-2"></span><span class="fs--1">Detail</span></button>

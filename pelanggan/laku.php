              ...
              <div class="row flex-between-center">
                ...
                <div class="col-sm-auto">
                  <div class="row gx-2 align-items-center">
                    ...
                    <div class="col-auto pe-0"> <a class="text-600 px-1" href="laku-list" data-bs-toggle="tooltip" data-bs-placement="top" title="Tampilkan List"><span class="fas fa-list-ul"></span></a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card shadow mb-3 ">
            <div class="card-body">
              <div class="row">
                ...
                $data = mysqli_query($koneksi,"SELECT * FROM produk ORDER BY terjual DESC");
                $jumlah_data = mysqli_num_rows($data);
                $total_halaman = ceil($jumlah_data / $batas);

                $data_produk = mysqli_query($koneksi,"SELECT * FROM produk ORDER BY terjual DESC LIMIT $halaman_awal, $batas");

                ...
                <div class="mb-4 col-md-6 col-lg-4">
                  <div class="border shadow rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                    <div class="overflow-hidden">
                      <div class="position-relative rounded-top overflow-hidden"><a class="d-block" href="detail-produk?kode=<?=$d['kode_produk']?>"><img class="img-fluid rounded-top border border" src="../fotoproduk/<?=$d['foto']?>" alt="" /></a><?=$banner_atas?>
                      </div>
                      <div class="p-3">

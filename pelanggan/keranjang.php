                    ...
                    <div class="col-md-8 d-flex justify-content-end justify-content-md-center order-1 order-md-0">
                      <div>
                        <div class="input-group input-group-sm flex-nowrap" data-quantity="data-quantity">
                          ...
                          <input class="form-control text-center px-2 input-spin-none" type="number" min="1" value="<?=$jml?>" aria-label="Amount (to the nearest dollar)" style="width: 50px" />
              ...
              <div class="row fw-bold gx-card mx-0">
                ...
                <div class="col px-0">
                  <div class="row gx-card mx-0">
                    <div class="col-md-8 py-2 d-none d-md-block text-center"><?=$jml_brg?> (items)</div>
                    <div class="col-12 col-md-4 text-end py-2">Rp.<?=number_format($totalbelanja)?></div>
                  </div>
                </div>
              </div>
            </div>

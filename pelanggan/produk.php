              ...
              <div class="row flex-between-center">
                ...
                <div class="col-sm-auto">
                  <div class="row gx-2 align-items-center">
                    ...
                    <div class="col-auto pe-0"> <a class="text-600 px-1" href="produk-list" data-bs-toggle="tooltip" data-bs-placement="top" title="Tampilkan List"><span class="fas fa-list-ul"></span></a></div>
                  </div>
                </div>
              </div>
            </div>

                      ...
                      <form class="row gx-2">
                        ...
                        <div class="col-auto">
                          <select class="form-select form-select-sm" aria-label="Bulk actions" onchange="location = this.value;">
                            ...
                            <option value="produk-list">Semua Produk</option>                            
                            <option value="populer-list">Paling Populer</option>                            
                          </select>
                        </div>
                      </form>
                    </div>
                    <div class="col-auto pe-0"><a class="text-600 px-1" href="laku" data-bs-toggle="tooltip" title="Tampilankan Grid"><span class="fas fa-th"></span></a></div>
                  </div>
                </div>
              </div>
            </div>

...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      ...
      <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        <h5 class="fs-0">Thema Web</h5>
        <p class="fs--1">silahkan pilih tampilan sesuai dengan selera anda.</p>
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="../assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
            <div class="flex-1">
              ...
              <p class="fs--1 mb-0">Tampilan Rata Kanan</p><a class="fs--1" href="#!">RTL Documentation</a>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-start"><img class="me-2" src="../assets/img/icons/arrows-h.svg" width="20" alt="" />
            <div class="flex-1">
              ...
              <p class="fs--1 mb-0">Tampilan halaman dalam ukuran layar penuh </p><a class="fs--1" href="#!">Fluid Documentation</a>
            </div>
          </div>
          <div class="form-check form-switch">
        ...
        <div class="text-center mt-5"><img class="mb-4" src="../assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
          <h5>Anda mengalami kesulitan?</h5>
          <p class="fs--1">Silahkan hubungi kami apabila anda mengalami kesulitan dalam berbelanja di situs kami.</p><a class="mb-3 btn btn-primary" href="#!" >Hubungi Kami</a>
        </div>
      </div>
